 ...
 * device MAC). MeshCore identities have no node-num; we seed
 * from the first 3 bytes of the node pubkey hex (or channel PSK hex)
 * instead. Ed25519 pubkeys are uniformly
