package io.github.thatsfguy.meshcore.platform.usbserial
 ...
 * library — covering the two chip families most USB-serial radio boards expose:
 *
 *   - **CDC-ACM** (USB Communications Device Class) — native-USB ESP32-S3 /
 *     ESP32-C3 boards and any standards-compliant USB-serial device.
 *   - **CP210x** (Silicon Labs CP2102 / CP2104) — the most common USB-UART
 *     bridge on T-Beam / Heltec-style boards.
 *
...
/** MeshCore firmware speaks 115200 8-N-1 over its USB serial line. */
const val MESHCORE_USB_BAUD = 115_200
...
object UsbSerialProber {
    ...
    fun open(device: UsbDevice, connection: UsbDeviceConnection, baud: Int = MESHCORE_USB_BAUD): UsbSerialPort? {
